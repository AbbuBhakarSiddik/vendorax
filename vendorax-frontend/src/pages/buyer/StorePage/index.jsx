        ...
        <div className="relative -mt-12 flex items-end gap-4 mb-4 animate-fade-in-up">
          ...
          <div className="pb-2">
            <div className="flex flex-wrap items-center gap-2 mb-1">
              ...
              <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold text-purple-700 bg-purple-50 border border-purple-200/80 px-2.5 py-0.5 rounded-full shadow-xs">
                <img src="/logo-icon.png" alt="VendoraX" className="w-3.5 h-3.5 object-contain" />
                VendoraX Verified Store
              </span>
            </div>
