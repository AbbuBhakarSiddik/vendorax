...
const stats = [
  { label: 'Total orders', value: '0', color: 'text-purple-700 bg-purple-50' },
  { label: 'Revenue', value: '₹0', color: 'text-teal-700 bg-teal-50' },
  { label: 'Products', value: '0', color: 'text-amber-700 bg-amber-50' },
  { label: 'Store views', value: '0', color: 'text-blue-700 bg-blue-50' },
]
